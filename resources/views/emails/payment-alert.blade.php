        ...
        <tbody>
            <tr>
                <td align="center" style="padding-top: 60px; padding-bottom: 50px;">
                    ...
                    <h2 style="max-width: 400px; font-size: 28px; line-height: 1.29; letter-spacing: -0.1px; text-align: center; color: #2c2b3f; font-family: HelveticaNeue, Helvetica, Arial, sans-serif; font-stretch: normal; font-weight: 500; padding-top: 0; padding-bottom: 0; margin: 25px auto;" align="center">{{ $full_name }} just funded<br> the escrow account with ₦{{$amount_paid}} for invoice number {{$invoice}}, send product to {{$full_name}}.</h2>
                    ...
                    <table align="center" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" style="text-align: center; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt;" class="user-info">
                        <tbody>
                            ...
                            <tr>
                                <td align="center">
                                    <a href="{{ route('dashboard') }}" style="font-family: Verdana, Arial, Tahoma; font-style: normal; border-radius: 100px; background: linear-gradient(-135deg, #78E5D7, #23C5DD); text-decoration: none; color: #FFFFFF; display: block; width: 250px; height: 50px; line-height: 50px; font-size: 16px; font-weight: bold; margin-top: 30px;" target="_blank">Request Logistics Now</a>
