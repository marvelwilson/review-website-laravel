                        ...
                        <div class="nk-block-head nk-block-head-sm">
                            <div class="nk-block-between position-relative">
                                <div class="nk-block-head-content">
                                    <h3 class="nk-block-title page-title">Registered Product</h3>
                                </div>
                                <div class="nk-block-head-content">
                                    <ul class="nk-block-tools g-1">
                                        <li><a href="#add-user" class="btn btn-primary" data-toggle="modal"><em class="icon ni ni-upload-cloud"></em> <span>Add Product</span></a></li>
                                    </ul>
                                </div>
                                            ...
                                            <td class="nk-tb-col">
                                                <div class="user-card">
                                                    <div class="tb-product">
                                                        ...
                                                        <img src="{{asset('storage/'.str_replace('public/','', $picture))}}" class="thumb" alt="{{$product->name}}">
...
@include('super_admin.product.create')
@endsection
@section('script')
        ...
        $("#addForm").submit((e) => {
            ...
            $.ajax({
                ...
                , success: (response) => {
                    ...
                    if (response.success) {
                        $(".add-btn").text("Send");
                        /*   $('#table').append(" <tr><td> <div class='avatar-group'><a href='product_profile.html' class='avatar avatar-xs' data-toggle='tooltip' title='Melissa Ayre'> <img src='' alt='people' class='avatar-img rounded-circle' /></a></div> </td><td>" + data.author + "</td><td>"
                            data.title "</td><td>"
