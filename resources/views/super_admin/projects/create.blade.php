        ...
        <div class="modal-content">
            ...
            <div class="modal-body modal-body-md">
                <div class="nk-upload-form">
                    <h5 class="title mb-3">Create Project</h5>
                    <form id="addForm" enctype="multipart/form-data">
                        ...
                        <div class="row gy-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <div class="custom-file">
                                            <input type="file" multiple="multiple" name="image[]" class="custom-file-input" id="customFile">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-control-wrap">
                                    <textarea class="form-control form-control-sm" name="desc" id="full_desc"></textarea>
                                </div>
                            </div>
                            <div class="col-12">
