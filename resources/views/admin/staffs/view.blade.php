    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Staffs</h1>
                <small>From here you can View, Add, Edit and Delete staff.</small>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="fs-17 font-weight-600 mb-0">All Staffs</h6>
                        </div>
                        <div class="text-right">
                            <div class="actions">
                                <button class="btn btn-success md-trigger mb-2 mr-1" data-toggle="modal" data-target="#addmodal">Add Staff</button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table id="example table" class="table display table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="avatar-group">
                                            <a href="user_profile.html" class="avatar avatar-xs" data-toggle="tooltip" title="Melissa Ayre">
                                                ...
                                                <img src="{{asset('storage/'.str_replace('public/','', $staff->image))}}" alt="people" class="avatar-img rounded-circle" />
                                    ...
                                    <td>
                                        <a href="#" class="btn btn-success-soft btn-sm mr-1 editbtn" data-id="{{$staff->id}}" data-name="{{$staff->name}}" data-content="{{$staff->content}}" data-position="{{$staff->position}}"> <i class="far fa-eye"></i></a>

                                        <a href="{{route('admin.deletestaff', ['id'=> $staff->id])}}" class="btn btn-danger-soft btn-sm"><i class="far fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                @endforeach
