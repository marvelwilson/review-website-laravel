    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                ...
                <small>From here you can View, Add, Edit and Delete msg.</small>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="fs-17 font-weight-600 mb-0">All Messages</h6>
                        </div>
                        ...
                        <table id="example table" class="table display table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="btn btn-success-soft btn-sm mr-1 editbtn" data-content="{{$msg->message}}"> <i class="far fa-eye"></i></a>

                                        <a href="{{route('admin.deletemessage', ['id'=> $msg->id])}}" class="btn btn-danger-soft btn-sm"><i class="far fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                @endforeach
