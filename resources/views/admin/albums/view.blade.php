    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                ...
                <small>From here you can View, Add, Edit and Delete album.</small>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="fs-17 font-weight-600 mb-0">All Albums</h6>
                        </div>
                        <div class="text-right">
                            <div class="actions">
                                <button class="btn btn-success md-trigger mb-2 mr-1" data-toggle="modal" data-target="#addmodal">Add Album</button>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <td>
                                        <div class="avatar-group">
                                            <a href="user_profile.html" class="avatar avatar-xs" data-toggle="tooltip" title="Melissa Ayre">
                                                ...
                                                <img src="{{asset('storage/'.str_replace('public/','', $album->image))}}" alt="people" class="avatar-img rounded-circle" />

                                            </a>
                                        </div>
                                    </td>
                                    <td>{{$album->title}}</td>
                                    <td> <a href="{{route('admin.viewgallery', ['id'=> $album->id])}}" class="btn btn-info-soft btn-sm"><i class="far fa-copy"></i></a>
                                    </td>
                                    <td>{{ \Carbon\Carbon::parse($album->created_at)->diffForHumans() }}</td>

                                    <td>
                                        <a href="#" class="btn btn-success-soft btn-sm mr-1 editbtn" data-id="{{$album->id}}" data-name="{{$album->title}}"> <i class="far fa-eye"></i></a>

                                        <a href="{{route('admin.deletealbum', ['id'=> $album->id])}}" class="btn btn-danger-soft btn-sm"><i class="far fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                @endforeach
