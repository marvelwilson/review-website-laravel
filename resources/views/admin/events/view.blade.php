    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                ...
                <small>From here you can View, Add, Edit and Delete event.</small>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="fs-17 font-weight-600 mb-0">All Events</h6>
                        </div>
                        <div class="text-right">
                            <div class="actions">
                                <button class="btn btn-success md-trigger mb-2 mr-1" data-toggle="modal" data-target="#addmodal">Add Event</button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table id="example table" class="table display table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="avatar-group">
                                            <a href="user_profile.html" class="avatar avatar-xs" data-toggle="tooltip" title="Melissa Ayre">
                                                ...
                                                <img src="{{asset('storage/'.str_replace('public/','', $event->image))}}" alt="people" class="avatar-img rounded-circle" />
                                    ...
                                    <td>
                                        <a href="#" class="btn btn-success-soft btn-sm mr-1 editbtn" data-id="{{$event->id}}" data-title="{{$event->title}}" data-date="{{$event->date}}" data-content="{{$event->content}}"> <i class="far fa-eye"></i></a>

                                        <a href="{{route('admin.deleteevent', ['id'=> $event->id])}}" class="btn btn-danger-soft btn-sm"><i class="far fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                @endforeach
