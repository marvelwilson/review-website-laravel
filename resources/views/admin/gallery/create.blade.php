    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-600" id="successModalLabel">Add Image</h5>
            ...
            <div class="modal-body">
                <form id="addForm" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input class="form-control mt-2" hidden type="text" id="album_id" value="{{$album_id}}" name="album_id" placeholder="Enter Album name">
