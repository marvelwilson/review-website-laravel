...
<div class="content-header row align-items-center m-0">
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            ...
            <li class="breadcrumb-item active">Gallerys</li>
        </ol>
    </nav>
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Gallerys</h1>
                <small>From here you can View, Add, Edit and Delete gallery.</small>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="fs-17 font-weight-600 mb-0">All Gallerys</h6>
                        </div>
                        <div class="text-right">
                            <div class="actions">
                                <button class="btn btn-success md-trigger mb-2 mr-1" data-toggle="modal" data-target="#addmodal">Add Gallery</button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table id="example table" class="table display table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="avatar-group">
                                            <a href="user_profile.html" class="avatar avatar-xs" data-toggle="tooltip" title="Melissa Ayre">
                                                ...
                                                <img src="{{asset('storage/'.str_replace('public/','', $gallery->image))}}" alt="people" class="avatar-img rounded-circle" />
                                    ...
                                    <td>
                                        <a href="{{route('admin.deletegallery', ['id'=> $gallery->id])}}" class="btn btn-danger-soft btn-sm"><i class="far fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                @endforeach
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.editbtn').on('click', function(e) {
            ...
            $("#titl").val($(this).attr("data-title"));
            $("#lin").val($(this).attr("data-link"));
        })
