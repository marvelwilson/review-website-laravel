                                ...
                                <div class="card-inner-group" data-simplebar>
                                    ...
                                    <div class="card-inner p-0">
                                        <ul class="link-list-menu">
                                            <li><a href="{{ route('user.viewprofile') }}"><em class="icon ni ni-user-fill-c"></em><span>Personal Infomation</span></a></li>
                                            <li><a class="active" href="{{ route('user.viewdocument') }}"><em class="icon ni ni-grid-add-fill-c"></em><span>Documents</span></a></li>
