                            ...
                            <div class="card-inner card-inner-lg">
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control " id="email" name="email" class="form-control form-control-lg" placeholder="Enter your email address">
                                    </div>
                                    <div class="form-group">
                                        <div class="form-label-group">
                                    ...
                                    <div class="custom-control custom-checkbox mb-3">
                                        ...
                                        <label class="custom-control-label" for="remember">Remember me next time </label>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="nk-block-content text-center text-lg-left">
                                        <p class="text-soft">&copy; 2021 Pay and deliver. Designed by <a target="blank" href="https://emmanueliwuoha.xcrowgold.com/">Xcrowgold</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
